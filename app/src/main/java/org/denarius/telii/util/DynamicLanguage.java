...
import org.denarius.telii.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link org.denarius.telii.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
