...
import org.denarius.telii.jobs.RemoteConfigRefreshJob;
...
public final class FeatureFlags {
  ...
  public static synchronized boolean usernames() {
    boolean value = getBoolean(USERNAMES, true);
  ...
  public static boolean newGroupUI() {
    return getBoolean(NEW_GROUP_UI, true);
  }

  /** React with Any Emoji */
  public static boolean reactWithAnyEmoji() {
    return getBoolean(REACT_WITH_ANY_EMOJI, true);
  }

  /** Groups v2 send and receive. */
  public static boolean groupsV2() {
    return org.whispersystems.signalservice.FeatureFlags.ZK_GROUPS && getBoolean(GROUPS_V2, true);
  }

  /** Groups v2 send and receive. */
  public static boolean groupsV2create() {
    return groupsV2() && getBoolean(GROUPS_V2_CREATE, true);
  }
