...
import org.denarius.telii.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.denarius.provider.telii/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.denarius.provider.telii", "part/*/#", SINGLE_ROW);
  }
