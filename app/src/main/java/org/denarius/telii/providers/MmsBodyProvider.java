...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.denarius.provider.telii.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("org.denarius.provider.telii.mms", "mms/#", SINGLE_ROW);
  }
