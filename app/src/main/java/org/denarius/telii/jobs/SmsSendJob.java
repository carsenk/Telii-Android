...
import org.denarius.telii.service.SmsDeliveryListener;
...
public class SmsSendJob extends SendJob {
  ...
  public static class Factory implements Job.Factory<SmsSendJob> {
    @Override
    public @NonNull SmsSendJob create(@NonNull Parameters parameters, @NonNull org.denarius.telii.jobmanager.Data data) {
