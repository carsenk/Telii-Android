...
import org.denarius.telii.components.RemovableEditableMediaView;
import org.denarius.telii.components.ThumbnailView;
import org.denarius.telii.components.location.SignalMapView;
...
import org.denarius.telii.providers.DeprecatedPersistentBlobProvider;
...
import org.denarius.telii.util.concurrent.ListenableFuture.Listener;
...
public class AttachmentManager {
  ...
  public static void selectPayment(Activity activity, int requestCode) {
    Permissions.with(activity)
            .request(Manifest.permission.WRITE_EXTERNAL_STORAGE)
            .ifNecessary()
            .withPermanentDenialDialog(activity.getString(R.string.AttachmentManager_signal_requires_the_external_storage_permission_in_order_to_attach_photos_videos_or_audio))
