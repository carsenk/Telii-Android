...
import org.denarius.telii.attachments.MmsNotificationAttachment;
import org.denarius.telii.contactshare.Contact;
import org.denarius.telii.database.documents.IdentityKeyMismatch;
import org.denarius.telii.database.documents.IdentityKeyMismatchList;
import org.denarius.telii.database.documents.NetworkFailure;
import org.denarius.telii.database.documents.NetworkFailureList;
import org.denarius.telii.database.helpers.SQLCipherOpenHelper;
import org.denarius.telii.database.model.MediaMmsMessageRecord;
import org.denarius.telii.database.model.MessageRecord;
import org.denarius.telii.database.model.NotificationMmsMessageRecord;
...
import org.denarius.telii.mms.MessageGroupContext;
...
import org.denarius.telii.revealable.ViewOnceExpirationInfo;
...
import static org.denarius.telii.contactshare.Contact.Avatar;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.denarius.telii.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.denarius.telii.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.denarius.telii.util.Util.toIsoBytes(transactionId);
