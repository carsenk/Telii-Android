 ...
 */
package org.denarius.telii.database.model;
...
import org.denarius.telii.database.ThreadDatabase.Extra;
...
public class ThreadRecord extends DisplayRecord {
  ...
  public SpannableString getDisplayBody(@NonNull Context context) {
    if (getGroupAddedBy() != null) {
      ...
      return emphasisAdded(context.getString(org.denarius.telii.R.string.ThreadRecord_called));
    } else if (SmsDatabase.Types.isIncomingCall(type)) {
      return emphasisAdded(context.getString(org.denarius.telii.R.string.ThreadRecord_called_you));
    } else if (SmsDatabase.Types.isMissedCall(type)) {
      return emphasisAdded(context.getString(org.denarius.telii.R.string.ThreadRecord_missed_call));
