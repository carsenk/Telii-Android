package org.denarius.telii.registration.fragments;
...
import org.denarius.telii.AppInitialization;
import org.denarius.telii.R;
import org.denarius.telii.backup.BackupPassphrase;
import org.denarius.telii.backup.FullBackupBase;
import org.denarius.telii.backup.FullBackupImporter;
import org.denarius.telii.crypto.AttachmentSecretProvider;
import org.denarius.telii.database.DatabaseFactory;
import org.denarius.telii.database.NoExternalStorageException;
...
import org.denarius.telii.util.BackupUtil;
    ...
    new AsyncTask<Void, Void, BackupImportResult>() {
      ...
      protected BackupImportResult doInBackground(Void... voids) {
        try {
          ...
          Log.w(TAG, "Failed due to the backup being from a newer version of Telii.", e);
