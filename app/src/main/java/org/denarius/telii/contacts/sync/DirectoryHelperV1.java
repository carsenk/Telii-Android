...
import org.denarius.telii.crypto.SessionUtil;
...
import org.denarius.telii.sms.IncomingJoinedMessage;
...
class DirectoryHelperV1 {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("org.denarius.telii");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "org.denarius.telii");
