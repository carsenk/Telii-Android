...
public class VerificationCodeParserTest extends BaseUnitTest {
  private static Map<String, String> CHALLENGES = new HashMap<String,String>() {{
      ...
      put("Your Telii verification code: 337-337",        "337337");
      put("XXX\nYour Telii verification code: 1337-1337", "13371337");
      put("Your Telii verification code: 337-1337",       "3371337");
      put("Your Telii verification code: 1337-337",       "1337337");
      put("Your Telii verification code: 1337-1337",      "13371337");
      put("XXXYour Telii verification code: 1337-1337",   "13371337");
      put("Your Telii verification code: 1337-1337XXX",   "13371337");
      put("Your Telii verification code 1337-1337",       "13371337");

      put("<#>Your Telii verification code: 1337-1337 aAbBcCdDeEf",     "13371337");
      put("<#> Your Telii verification code: 1337-1337 aAbBcCdDeEf",    "13371337");
      put("<#>Your Telii verification code: 1337-1337\naAbBcCdDeEf",    "13371337");
      put("<#> Your Telii verification code: 1337-1337\naAbBcCdDeEf",   "13371337");
      put("<#> Your Telii verification code: 1337-1337\n\naAbBcCdDeEf", "13371337");
  }};
